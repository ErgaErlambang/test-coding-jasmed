        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <div class="dropdown dropdown-inline mr-2">
                    @if(\Auth::user()->getRole()->slug == 'admin' || \Auth::user()->getRole()->slug == 'apoteker')
                        <a href="{{ route('obat.create') }}" class="btn btn-primary font-weight-bolder"><i class="la la-plus"></i>New Record</a>
                    @endif
                </div>
            </div>
        </div>
